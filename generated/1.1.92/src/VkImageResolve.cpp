...
NAN_GETTER(_VkImageResolve::GetsrcSubresource) {
  ...
  if (!value->IsNull()) {
    ...
    std::string msg = "Expected '[object VkImageSubresourceLayers]' for 'VkImageResolve.srcSubresource' but got '" + details + "'";
...
NAN_GETTER(_VkImageResolve::GetsrcOffset) {
  ...
  if (!value->IsNull()) {
    ...
    std::string details = getV8ObjectDetails(value);
    if (details[0] == '#') details = "[object " + (details.substr(2, details.length() - 2 - 1)) + "]";
    std::string msg = "Expected '[object VkOffset3D]' for 'VkImageResolve.srcOffset' but got '" + details + "'";
    Nan::ThrowTypeError(msg.c_str());
      return;
    }
  } else if (value->IsNull()) {
...
NAN_GETTER(_VkImageResolve::GetdstSubresource) {
  ...
  if (!value->IsNull()) {
    ...
    std::string details = getV8ObjectDetails(value);
    if (details[0] == '#') details = "[object " + (details.substr(2, details.length() - 2 - 1)) + "]";
    std::string msg = "Expected '[object VkImageSubresourceLayers]' for 'VkImageResolve.dstSubresource' but got '" + details + "'";
    Nan::ThrowTypeError(msg.c_str());
      return;
    }
  } else if (value->IsNull()) {
...
NAN_GETTER(_VkImageResolve::GetdstOffset) {
  ...
  if (!value->IsNull()) {
    ...
    std::string details = getV8ObjectDetails(value);
    if (details[0] == '#') details = "[object " + (details.substr(2, details.length() - 2 - 1)) + "]";
    std::string msg = "Expected '[object VkOffset3D]' for 'VkImageResolve.dstOffset' but got '" + details + "'";
    Nan::ThrowTypeError(msg.c_str());
      return;
    }
  } else if (value->IsNull()) {
...
NAN_GETTER(_VkImageResolve::Getextent) {
  ...
  if (!value->IsNull()) {
    ...
    std::string details = getV8ObjectDetails(value);
    if (details[0] == '#') details = "[object " + (details.substr(2, details.length() - 2 - 1)) + "]";
    std::string msg = "Expected '[object VkExtent3D]' for 'VkImageResolve.extent' but got '" + details + "'";
    Nan::ThrowTypeError(msg.c_str());
      return;
    }
  } else if (value->IsNull()) {
