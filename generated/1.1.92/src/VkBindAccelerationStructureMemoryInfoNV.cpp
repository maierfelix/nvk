...
NAN_GETTER(_VkBindAccelerationStructureMemoryInfoNV::GetsType) {
  ...
  if (value->IsNumber()) {
    ...
    std::string msg = "Expected 'Number' for 'VkBindAccelerationStructureMemoryInfoNV.sType' but got '" + details + "'";
...
NAN_GETTER(_VkBindAccelerationStructureMemoryInfoNV::GetaccelerationStructure) {
  ...
  if (!value->IsNull()) {
    ...
    std::string details = getV8ObjectDetails(value);
    if (details[0] == '#') details = "[object " + (details.substr(2, details.length() - 2 - 1)) + "]";
    std::string msg = "Expected '[object VkAccelerationStructureNV]' for 'VkBindAccelerationStructureMemoryInfoNV.accelerationStructure' but got '" + details + "'";
    Nan::ThrowTypeError(msg.c_str());
      return;
    }
...
NAN_GETTER(_VkBindAccelerationStructureMemoryInfoNV::Getmemory) {
  ...
  if (!value->IsNull()) {
    ...
    std::string details = getV8ObjectDetails(value);
    if (details[0] == '#') details = "[object " + (details.substr(2, details.length() - 2 - 1)) + "]";
    std::string msg = "Expected '[object VkDeviceMemory]' for 'VkBindAccelerationStructureMemoryInfoNV.memory' but got '" + details + "'";
    Nan::ThrowTypeError(msg.c_str());
      return;
    }
  } else if (value->IsNull()) {
...
NAN_GETTER(_VkBindAccelerationStructureMemoryInfoNV::GetmemoryOffset) {
  ...
  if (value->IsNumber()) {
    ...
    std::string details = getV8ObjectDetails(value);
    if (details[0] == '#') details = "[object " + (details.substr(2, details.length() - 2 - 1)) + "]";
    std::string msg = "Expected 'Number' for 'VkBindAccelerationStructureMemoryInfoNV.memoryOffset' but got '" + details + "'";
    Nan::ThrowTypeError(msg.c_str());
    return;
  }
}// deviceIndexCount
NAN_GETTER(_VkBindAccelerationStructureMemoryInfoNV::GetdeviceIndexCount) {
  ...
  if (value->IsNumber()) {
    ...
    std::string details = getV8ObjectDetails(value);
    if (details[0] == '#') details = "[object " + (details.substr(2, details.length() - 2 - 1)) + "]";
    std::string msg = "Expected 'Number' for 'VkBindAccelerationStructureMemoryInfoNV.deviceIndexCount' but got '" + details + "'";
    Nan::ThrowTypeError(msg.c_str());
    return;
  }
}// pDeviceIndices
NAN_GETTER(_VkBindAccelerationStructureMemoryInfoNV::GetpDeviceIndices) {
  ...
  _VkBindAccelerationStructureMemoryInfoNV *self = Nan::ObjectWrap::Unwrap<_VkBindAccelerationStructureMemoryInfoNV>(info.This());
    ...
    std::string details = getV8ObjectDetails(value);
    if (details[0] == '#') details = "[object " + (details.substr(2, details.length() - 2 - 1)) + "]";
    std::string msg = "Expected 'Uint32Array' for 'VkBindAccelerationStructureMemoryInfoNV.pDeviceIndices' but got '" + details + "'";
    Nan::ThrowTypeError(msg.c_str());
        return;
      }
    } else if (value->IsNull()) {
