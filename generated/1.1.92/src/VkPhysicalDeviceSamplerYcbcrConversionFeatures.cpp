...
NAN_GETTER(_VkPhysicalDeviceSamplerYcbcrConversionFeatures::GetsType) {
  ...
  if (value->IsNumber()) {
    ...
    std::string msg = "Expected 'Number' for 'VkPhysicalDeviceSamplerYcbcrConversionFeatures.sType' but got '" + details + "'";
...
NAN_GETTER(_VkPhysicalDeviceSamplerYcbcrConversionFeatures::GetsamplerYcbcrConversion) {
  ...
  if (value->IsBoolean() || value->IsNumber()) {
    ...
    std::string details = getV8ObjectDetails(value);
    if (details[0] == '#') details = "[object " + (details.substr(2, details.length() - 2 - 1)) + "]";
    std::string msg = "Expected 'Number' for 'VkPhysicalDeviceSamplerYcbcrConversionFeatures.samplerYcbcrConversion' but got '" + details + "'";
    Nan::ThrowTypeError(msg.c_str());
    return;
  }
}