...
NAN_GETTER(_VkAccelerationStructureMemoryRequirementsInfoNV::GetsType) {
  ...
  if (value->IsNumber()) {
    ...
    std::string msg = "Expected 'Number' for 'VkAccelerationStructureMemoryRequirementsInfoNV.sType' but got '" + details + "'";
...
NAN_GETTER(_VkAccelerationStructureMemoryRequirementsInfoNV::Gettype) {
  ...
  if (value->IsNumber()) {
    ...
    std::string details = getV8ObjectDetails(value);
    if (details[0] == '#') details = "[object " + (details.substr(2, details.length() - 2 - 1)) + "]";
    std::string msg = "Expected 'Number' for 'VkAccelerationStructureMemoryRequirementsInfoNV.type' but got '" + details + "'";
    Nan::ThrowTypeError(msg.c_str());
    return;
  }
...
NAN_GETTER(_VkAccelerationStructureMemoryRequirementsInfoNV::GetaccelerationStructure) {
  ...
  if (!value->IsNull()) {
    ...
    std::string details = getV8ObjectDetails(value);
    if (details[0] == '#') details = "[object " + (details.substr(2, details.length() - 2 - 1)) + "]";
    std::string msg = "Expected '[object VkAccelerationStructureNV]' for 'VkAccelerationStructureMemoryRequirementsInfoNV.accelerationStructure' but got '" + details + "'";
    Nan::ThrowTypeError(msg.c_str());
      return;
    }
