...
static Napi::Value getStructureByteSize(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  //int out = GetStructureByteSize(info[0].As<Napi::Object>());
  int out = 0;
...
Napi::Object Init(Napi::Env env, Napi::Object exports) {
  ...
  exports["getStructureByteSize"] = Napi::Function::New(env, getStructureByteSize, "getStructureByteSize");
  ...
  _VkCooperativeMatrixPropertiesNV::Initialize(env, exports);
  _VkPhysicalDeviceCooperativeMatrixPropertiesNV::Initialize(env, exports);
  _VkPhysicalDeviceCooperativeMatrixFeaturesNV::Initialize(env, exports);
  _VkFilterCubicImageViewImageFormatPropertiesEXT::Initialize(env, exports);
  _VkPhysicalDeviceImageViewImageFormatInfoEXT::Initialize(env, exports);
  _VkBufferDeviceAddressCreateInfoEXT::Initialize(env, exports);
  _VkBufferDeviceAddressInfoEXT::Initialize(env, exports);
  _VkPhysicalDeviceBufferAddressFeaturesEXT::Initialize(env, exports);
  _VkMemoryPriorityAllocateInfoEXT::Initialize(env, exports);
  _VkPhysicalDeviceMemoryPriorityFeaturesEXT::Initialize(env, exports);
  _VkPhysicalDeviceMemoryBudgetPropertiesEXT::Initialize(env, exports);
  _VkPipelineRasterizationDepthClipStateCreateInfoEXT::Initialize(env, exports);
  _VkPhysicalDeviceDepthClipEnableFeaturesEXT::Initialize(env, exports);
  _VkPhysicalDeviceScalarBlockLayoutFeaturesEXT::Initialize(env, exports);
  _VkRenderPassFragmentDensityMapCreateInfoEXT::Initialize(env, exports);
  _VkPhysicalDeviceFragmentDensityMapPropertiesEXT::Initialize(env, exports);
  _VkPhysicalDeviceFragmentDensityMapFeaturesEXT::Initialize(env, exports);
  _VkDeviceMemoryOverallocationCreateInfoAMD::Initialize(env, exports);
  _VkImageStencilUsageCreateInfoEXT::Initialize(env, exports);
  ...
  _VkPhysicalDeviceDedicatedAllocationImageAliasingFeaturesNV::Initialize(env, exports);
  ...
  _VkSubpassDescriptionDepthStencilResolveKHR::Initialize(env, exports);
  _VkPhysicalDeviceDepthStencilResolvePropertiesKHR::Initialize(env, exports);
  ...
  _VkPhysicalDeviceFloatControlsPropertiesKHR::Initialize(env, exports);
  _VkPhysicalDeviceFloat16Int8FeaturesKHR::Initialize(env, exports);
  ...
  _VkFenceGetWin32HandleInfoKHR::Initialize(env, exports);
  _VkExportFenceWin32HandleInfoKHR::Initialize(env, exports);
  _VkImportFenceWin32HandleInfoKHR::Initialize(env, exports);
  ...
  _VkSemaphoreGetWin32HandleInfoKHR::Initialize(env, exports);
  _VkD3D12FenceSubmitInfoKHR::Initialize(env, exports);
  _VkExportSemaphoreWin32HandleInfoKHR::Initialize(env, exports);
  _VkImportSemaphoreWin32HandleInfoKHR::Initialize(env, exports);
  ...
  _VkWin32KeyedMutexAcquireReleaseInfoKHR::Initialize(env, exports);
  ...
  _VkMemoryGetWin32HandleInfoKHR::Initialize(env, exports);
  _VkMemoryWin32HandlePropertiesKHR::Initialize(env, exports);
  _VkExportMemoryWin32HandleInfoKHR::Initialize(env, exports);
  _VkImportMemoryWin32HandleInfoKHR::Initialize(env, exports);
  ...
  _VkWin32KeyedMutexAcquireReleaseInfoNV::Initialize(env, exports);
  _VkExportMemoryWin32HandleInfoNV::Initialize(env, exports);
  _VkImportMemoryWin32HandleInfoNV::Initialize(env, exports);
  ...
  _VkValidationFeaturesEXT::Initialize(env, exports);
  ...
  _VkWin32SurfaceCreateInfoKHR::Initialize(env, exports);
