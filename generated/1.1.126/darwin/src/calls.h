...
static PFN_vkCreateMacOSSurfaceMVK $vkCreateMacOSSurfaceMVK = nullptr;
...
void vkUseInstance(VkInstance pInstance) {
  ...
  $vkCreateMacOSSurfaceMVK = (PFN_vkCreateMacOSSurfaceMVK) vkGetInstanceProcAddr(currentInstance, "vkCreateMacOSSurfaceMVK");
...
Napi::Value _vkCreateMacOSSurfaceMVK(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  ...
  if (info[0].IsObject()) {
    ...
    Napi::TypeError::New(env, "Expected 'VkInstance' or 'null' for argument 1 'instance' in 'vkCreateMacOSSurfaceMVK'").ThrowAsJavaScriptException();
    return env.Undefined();
  }

  Napi::Object obj1;
  VkMacOSSurfaceCreateInfoMVK *$p1 = nullptr;
  if (info[1].IsObject()) {
    Napi::Object obj = info[1].As<Napi::Object>();
    if (GetStructureTypeFromObject(obj) != VK_STRUCTURE_TYPE_MACOS_SURFACE_CREATE_INFO_MVK) {
      NapiObjectTypeError(info[1], "argument 2", "VkMacOSSurfaceCreateInfoMVK");
      return env.Undefined();
    }
    obj1 = obj;
    Napi::Value flushCall = obj.Get("flush").As<Napi::Function>().Call(obj, {  });
    if (!(flushCall.As<Napi::Boolean>().Value())) return env.Undefined();
    VkMacOSSurfaceCreateInfoMVK* instance = reinterpret_cast<VkMacOSSurfaceCreateInfoMVK*>(obj.Get("memoryBuffer").As<Napi::ArrayBuffer>().Data());
    $p1 = instance;
  } else if (info[1].IsNull()) {
    $p1 = nullptr;
  } else {
    Napi::TypeError::New(env, "Expected 'VkMacOSSurfaceCreateInfoMVK' or 'null' for argument 2 'pCreateInfo' in 'vkCreateMacOSSurfaceMVK'").ThrowAsJavaScriptException();
    return env.Undefined();
  }
  ...
  if (info[3].IsObject()) {
    ...
    Napi::TypeError::New(env, "Expected 'VkSurfaceKHR' or 'null' for argument 4 'pSurface' in 'vkCreateMacOSSurfaceMVK'").ThrowAsJavaScriptException();
    return env.Undefined();
  }
  int32_t out = $vkCreateMacOSSurfaceMVK(
    info[0].IsNull() ? VK_NULL_HANDLE : *$p0,
    $p1,
    nullptr,
    $p3
