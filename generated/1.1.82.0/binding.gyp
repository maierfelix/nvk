        ...
        [
          "OS=='win'",
          {
            "copies": [
              {
                "files": [
                  "<(root_dir)/lib/<(platform)/<(target_arch)/GLEW/glew32.dll",
                  "<(root_dir)/lib/<(platform)/<(target_arch)/GLFW/glfw3.dll"
                ],
...
"./src/index.cpp" ],
      ...
      "library_dirs": [
        "<(root_dir)/lib/<(platform)/<(target_arch)/GLFW",
        "<(root_dir)/lib/<(platform)/<(target_arch)/GLEW",
