...
std::map<std::string, std::string> _API_Extensions_Strings = {
  ...
  { "VK_NVX_EXTENSION_287_EXTENSION_NAME", "VK_NVX_extension_287" },
  ...
  { "VK_EXT_EXTENSION_298_EXTENSION_NAME", "VK_EXT_extension_298" },
  { "VK_KHR_EXTENSION_299_EXTENSION_NAME", "VK_KHR_extension_299" },
  { "VK_KHR_EXTENSION_300_EXTENSION_NAME", "VK_KHR_extension_300" },
  { "VK_NV_EXTENSION_301_EXTENSION_NAME", "VK_NV_extension_301" },
  { "VK_QCOM_extension_302_EXTENSION_NAME", "VK_QCOM_extension_302" },
...
std::map<std::string, int32_t> _API_Extensions = {
  ...
  { "VK_NVX_EXTENSION_287_SPEC_VERSION", 0 },
  { "VK_NVX_EXTENSION_288_SPEC_VERSION", 0 },
  ...
  { "VK_EXT_EXTENSION_298_SPEC_VERSION", 0 },
  { "VK_KHR_EXTENSION_299_SPEC_VERSION", 0 },
  { "VK_KHR_EXTENSION_300_SPEC_VERSION", 0 },
  { "VK_NV_EXTENSION_301_SPEC_VERSION", 0 },
  { "VK_QCOM_extension_302_SPEC_VERSION", 0 },
...
std::map<std::string, int32_t> _VkResult = {
  ...
  { "VK_RESULT_EXT_298_RESERVED_VALUE_0_EXT", 1000297000 },
...
std::map<std::string, int32_t> _VkPipelineCreateFlagBits = {
  ...
  { "VK_PIPELINE_CREATE_EXTENSION_151_BIT0_NV", 0x800 },
  { "VK_PIPELINE_CREATE_EXTENSION_151_BIT1_NV", 0x4000 },
  { "VK_PIPELINE_CREATE_EXTENSION_151_BIT2_NV", 0x8000 },
  { "VK_PIPELINE_CREATE_EXTENSION_151_BIT3_NV", 0x10000 },
  { "VK_PIPELINE_CREATE_EXTENSION_151_BIT4_NV", 0x20000 },
  ...
  { "VK_PIPELINE_CREATE_EXTENSION_291_BIT0_NV", 0x1000 },
  { "VK_PIPELINE_CREATE_EXTENSION_291_BIT1_NV", 0x2000 },
  { "VK_PIPELINE_CREATE_RESERVED_8_BIT_EXT", 0x100 },
  { "VK_PIPELINE_CREATE_RESERVED_9_BIT_EXT", 0x200 },
  { "VK_PIPELINE_CREATE_RESERVED_10_BIT_EXT", 0x400 },
...
std::map<std::string, int32_t> _VkSemaphoreCreateFlagBits = {
...
std::map<std::string, int32_t> _VkFormatFeatureFlagBits = {
  ...
  { "VK_FORMAT_FEATURE_RESERVED_29_BIT_NV", 0x20000000 },
...
Napi::Value getVulkanEnumerations(const Napi::CallbackInfo& info) {
  ...
  }
  {
    std::map<std::string, int32_t>::iterator it;
    Napi::Object entry = Napi::Object::New(env);
    for (it = _VkSemaphoreCreateFlagBits.begin(); it != _VkSemaphoreCreateFlagBits.end(); it++) {
      Napi::String accessor = Napi::String::New(env, it->first);
      entry.Set(accessor, Napi::Number::New(env, static_cast<int32_t>(it->second)));
      out.Set(accessor, Napi::Number::New(env, static_cast<int32_t>(it->second)));
    };
    out.Set(Napi::String::New(env, "VkSemaphoreCreateFlagBits"), entry);
  }
  {
    std::map<std::string, int32_t>::iterator it;
    Napi::Object entry = Napi::Object::New(env);
