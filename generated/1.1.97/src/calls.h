...
void _vkGetPhysicalDeviceCalibrateableTimeDomainsEXT(const Nan::FunctionCallbackInfo<v8::Value>& info) {
  ...
  VkTimeDomainEXT *$p2 = nullptr;

  if (info[2]->IsArray()) {

    v8::Local<v8::Array> array = v8::Local<v8::Array>::Cast(info[2]);
    VkTimeDomainEXT* arr2 = new VkTimeDomainEXT[array->Length()];
    $p2 = arr2;
  } else if (!info[2]->IsNull()) {
...
void _vkGetCalibratedTimestampsEXT(const Nan::FunctionCallbackInfo<v8::Value>& info) {
...

  {
    ...
    for (unsigned int ii = 0; ii < array->Length(); ++ii) {
      v8::Local<v8::Value> item = Nan::Get(array, ii).ToLocalChecked();
      _VkCalibratedTimestampInfoEXT* result = Nan::ObjectWrap::Unwrap<_VkCalibratedTimestampInfoEXT>(Nan::To<v8::Object>(item).ToLocalChecked());
      if (!result->flush()) return;
    };
  }
    v8::Local<v8::Array> array = v8::Local<v8::Array>::Cast(info[2]);
  ...
  if (info[3]->IsArray()) {
    ...
    $p3 = getTypedArrayData<uint64_t>(Nan::To<v8::Object>(info[3]).ToLocalChecked());
  } else if (!info[3]->IsNull()) {
...
void _vkCmdBindTransformFeedbackBuffersEXT(const Nan::FunctionCallbackInfo<v8::Value>& info) {
  ...
  std::shared_ptr<std::vector<VkDeviceSize>> $p5 = nullptr;

  if (info[5]->IsArray()) {

    std::vector<VkDeviceSize> data = createArrayOfV8Numbers<VkDeviceSize>(info[5]);
    $p5 = std::make_shared<std::vector<VkDeviceSize>>(data);
  } else if (!info[5]->IsNull()) {
...
void _vkCmdBeginTransformFeedbackEXT(const Nan::FunctionCallbackInfo<v8::Value>& info) {
...
void _vkCmdEndTransformFeedbackEXT(const Nan::FunctionCallbackInfo<v8::Value>& info) {
...
void _vkCmdBeginQueryIndexedEXT(const Nan::FunctionCallbackInfo<v8::Value>& info) {
...
void _vkCmdEndQueryIndexedEXT(const Nan::FunctionCallbackInfo<v8::Value>& info) {
...
void _vkCmdDrawIndirectByteCountEXT(const Nan::FunctionCallbackInfo<v8::Value>& info) {
...
void _vkCompileDeferredNV(const Nan::FunctionCallbackInfo<v8::Value>& info) {
...
void _vkCreateAccelerationStructureNV(const Nan::FunctionCallbackInfo<v8::Value>& info) {
...
void _vkDestroyAccelerationStructureNV(const Nan::FunctionCallbackInfo<v8::Value>& info) {
...
void _vkGetAccelerationStructureMemoryRequirementsNV(const Nan::FunctionCallbackInfo<v8::Value>& info) {
...
void _vkBindAccelerationStructureMemoryNV(const Nan::FunctionCallbackInfo<v8::Value>& info) {
...

  {
    ...
    for (unsigned int ii = 0; ii < array->Length(); ++ii) {
      v8::Local<v8::Value> item = Nan::Get(array, ii).ToLocalChecked();
      _VkBindAccelerationStructureMemoryInfoNV* result = Nan::ObjectWrap::Unwrap<_VkBindAccelerationStructureMemoryInfoNV>(Nan::To<v8::Object>(item).ToLocalChecked());
      if (!result->flush()) return;
    };
  }
    v8::Local<v8::Array> array = v8::Local<v8::Array>::Cast(info[2]);
...
void _vkCmdCopyAccelerationStructureNV(const Nan::FunctionCallbackInfo<v8::Value>& info) {
  ...
  VkCopyAccelerationStructureModeNV $p3 = static_cast<VkCopyAccelerationStructureModeNV>(Nan::To<int64_t>(info[3]).FromMaybe(0));
...
void _vkCmdWriteAccelerationStructuresPropertiesNV(const Nan::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (info[2]->IsArray()) {
    ...
    for (unsigned int ii = 0; ii < array->Length(); ++ii) {
      v8::Local<v8::Value> item = Nan::Get(array, ii).ToLocalChecked();
      _VkAccelerationStructureNV* result = Nan::ObjectWrap::Unwrap<_VkAccelerationStructureNV>(Nan::To<v8::Object>(item).ToLocalChecked());
      data[ii] = result->instance;
    };
  ...
  VkQueryType $p3 = static_cast<VkQueryType>(Nan::To<int64_t>(info[3]).FromMaybe(0));
...
void _vkCmdBuildAccelerationStructureNV(const Nan::FunctionCallbackInfo<v8::Value>& info) {
...
void _vkCmdTraceRaysNV(const Nan::FunctionCallbackInfo<v8::Value>& info) {
  ...
  uint64_t $p10 = static_cast<uint64_t>(Nan::To<int64_t>(info[10]).FromMaybe(0));

  uint64_t $p11 = static_cast<uint64_t>(Nan::To<int64_t>(info[11]).FromMaybe(0));

  uint32_t $p12 = static_cast<uint32_t>(Nan::To<int64_t>(info[12]).FromMaybe(0));

  uint32_t $p13 = static_cast<uint32_t>(Nan::To<int64_t>(info[13]).FromMaybe(0));

  uint32_t $p14 = static_cast<uint32_t>(Nan::To<int64_t>(info[14]).FromMaybe(0));
$vkCmdTraceRaysNV(
    info[0]->IsNull() ? VK_NULL_HANDLE : *$p0,
    info[1]->IsNull() ? VK_NULL_HANDLE : *$p1,
    $p2,
...
void _vkGetRayTracingShaderGroupHandlesNV(const Nan::FunctionCallbackInfo<v8::Value>& info) {
...
void _vkGetAccelerationStructureHandleNV(const Nan::FunctionCallbackInfo<v8::Value>& info) {
...
void _vkCreateRayTracingPipelinesNV(const Nan::FunctionCallbackInfo<v8::Value>& info) {
...

  {
    ...
    for (unsigned int ii = 0; ii < array->Length(); ++ii) {
      v8::Local<v8::Value> item = Nan::Get(array, ii).ToLocalChecked();
      _VkRayTracingPipelineCreateInfoNV* result = Nan::ObjectWrap::Unwrap<_VkRayTracingPipelineCreateInfoNV>(Nan::To<v8::Object>(item).ToLocalChecked());
      if (!result->flush()) return;
    };
  }
    v8::Local<v8::Array> array = v8::Local<v8::Array>::Cast(info[3]);
...
void _vkGetImageDrmFormatModifierPropertiesEXT(const Nan::FunctionCallbackInfo<v8::Value>& info) {
...
void _vkGetBufferDeviceAddressEXT(const Nan::FunctionCallbackInfo<v8::Value>& info) {
