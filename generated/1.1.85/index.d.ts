...
declare function vkGetMemoryWin32HandleNV(device: VkDevice | null, memory: VkDeviceMemory | null, handleType: VkExternalMemoryHandleTypeFlagBitsNV, pHandle: VkInoutAddress): number;
...
declare function vkGetMemoryWin32HandleKHR(device: VkDevice | null, pGetWin32HandleInfo: VkMemoryGetWin32HandleInfoKHR | null, pHandle: VkInoutAddress): number;
declare function vkGetMemoryWin32HandlePropertiesKHR(device: VkDevice | null, handleType: number, handle: bigint, pMemoryWin32HandleProperties: VkMemoryWin32HandlePropertiesKHR | null): number;
...
declare function vkGetSemaphoreWin32HandleKHR(device: VkDevice | null, pGetWin32HandleInfo: VkSemaphoreGetWin32HandleInfoKHR | null, pHandle: VkInoutAddress): number;
...
declare function vkGetFenceWin32HandleKHR(device: VkDevice | null, pGetWin32HandleInfo: VkFenceGetWin32HandleInfoKHR | null, pHandle: VkInoutAddress): number;
...
declare function vkDestroyAccelerationStructureNVX(device: VkDevice | null, accelerationStructure: VkAccelerationStructureNVX | null, pAllocator: null): void;
declare function vkGetAccelerationStructureMemoryRequirementsNVX(device: VkDevice | null, pInfo: VkAccelerationStructureMemoryRequirementsInfoNVX | null, pMemoryRequirements: VkMemoryRequirements2KHR | null): void;
declare function vkGetAccelerationStructureScratchMemoryRequirementsNVX(device: VkDevice | null, pInfo: VkAccelerationStructureMemoryRequirementsInfoNVX | null, pMemoryRequirements: VkMemoryRequirements2KHR | null): void;
...
declare function vkCmdCopyAccelerationStructureNVX(cmdBuf: VkCommandBuffer | null, dst: VkAccelerationStructureNVX | null, src: VkAccelerationStructureNVX | null, mode: VkCopyAccelerationStructureModeNVX): void;
declare function vkCmdWriteAccelerationStructurePropertiesNVX(cmdBuf: VkCommandBuffer | null, accelerationStructure: VkAccelerationStructureNVX | null, queryType: VkQueryType, queryPool: VkQueryPool | null, query: number): void;
declare function vkCmdBuildAccelerationStructureNVX(cmdBuf: VkCommandBuffer | null, type: VkAccelerationStructureTypeNVX, instanceCount: number, instanceData: VkBuffer | null, instanceOffset: number, geometryCount: number, pGeometries: VkGeometryNVX[] | null, flags: VkBuildAccelerationStructureFlagBitsNVX, update: number, dst: VkAccelerationStructureNVX | null, src: VkAccelerationStructureNVX | null, scratch: VkBuffer | null, scratchOffset: number): void;
declare function vkCmdTraceRaysNVX(cmdBuf: VkCommandBuffer | null, raygenShaderBindingTableBuffer: VkBuffer | null, raygenShaderBindingOffset: number, missShaderBindingTableBuffer: VkBuffer | null, missShaderBindingOffset: number, missShaderBindingStride: number, hitShaderBindingTableBuffer: VkBuffer | null, hitShaderBindingOffset: number, hitShaderBindingStride: number, width: number, height: number): void;
declare function vkGetRaytracingShaderHandlesNVX(device: VkDevice | null, pipeline: VkPipeline | null, firstGroup: number, groupCount: number, dataSize: number, pData: ArrayBuffer | null): number;
declare function vkGetAccelerationStructureHandleNVX(device: VkDevice | null, accelerationStructure: VkAccelerationStructureNVX | null, dataSize: number, pData: ArrayBuffer | null): number;
