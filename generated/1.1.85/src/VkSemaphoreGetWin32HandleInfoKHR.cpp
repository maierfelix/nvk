...
NAN_GETTER(_VkSemaphoreGetWin32HandleInfoKHR::GetpNext) {
  _VkSemaphoreGetWin32HandleInfoKHR *self = Nan::ObjectWrap::Unwrap<_VkSemaphoreGetWin32HandleInfoKHR>(info.This());
}NAN_SETTER(_VkSemaphoreGetWin32HandleInfoKHR::SetpNext) {
  _VkSemaphoreGetWin32HandleInfoKHR *self = Nan::ObjectWrap::Unwrap<_VkSemaphoreGetWin32HandleInfoKHR>(info.This());
}// semaphore
NAN_GETTER(_VkSemaphoreGetWin32HandleInfoKHR::Getsemaphore) {
  ...
  if (!(value->IsNull())) {
    ...
    //self->semaphore = Nan::Persistent<v8::Object, v8::CopyablePersistentTraits<v8::Object>>(Nan::Null());
  }
  // vulkan
  if (!(value->IsNull())) {
    _VkSemaphore* obj = Nan::ObjectWrap::Unwrap<_VkSemaphore>(value->ToObject());
    self->instance.semaphore = obj->instance;
  } else {
...
NAN_GETTER(_VkSemaphoreGetWin32HandleInfoKHR::GethandleType) {
  ...
  _VkSemaphoreGetWin32HandleInfoKHR *self = Nan::ObjectWrap::Unwrap<_VkSemaphoreGetWin32HandleInfoKHR>(info.This());
  self->instance.handleType = static_cast<VkExternalSemaphoreHandleTypeFlagBits>((int32_t)value->NumberValue());
}