...
Napi::Value _vkCompileDeferredNVX(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
...
Napi::Value _vkCreateAccelerationStructureNVX(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  ...
  if (info[1].IsObject()) {
    Napi::Object obj = info[1].As<Napi::Object>();
    if (!(obj.InstanceOf(_VkAccelerationStructureCreateInfoNVX::constructor.Value()))) {
      NapiObjectTypeError(info[1], "argument 2", "[object VkAccelerationStructureCreateInfoNVX]");
      return env.Undefined();
    }
    obj1 = Napi::ObjectWrap<_VkAccelerationStructureCreateInfoNVX>::Unwrap(obj);
    if (!obj1->flush()) return env.Undefined();
    $p1 = &obj1->instance;
  } else if (info[1].IsNull()) {
    $p1 = nullptr;
  ...
  if (info[3].IsObject()) {
    Napi::Object obj = info[3].As<Napi::Object>();
    if (!(obj.InstanceOf(_VkAccelerationStructureNVX::constructor.Value()))) {
      NapiObjectTypeError(info[3], "argument 4", "[object VkAccelerationStructureNVX]");
      return env.Undefined();
    }
    obj3 = Napi::ObjectWrap<_VkAccelerationStructureNVX>::Unwrap(obj);
...
Napi::Value _vkDestroyAccelerationStructureNVX(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  ...
  if (info[1].IsObject()) {
    Napi::Object obj = info[1].As<Napi::Object>();
    if (!(obj.InstanceOf(_VkAccelerationStructureNVX::constructor.Value()))) {
      NapiObjectTypeError(info[1], "argument 2", "[object VkAccelerationStructureNVX]");
      return env.Undefined();
    }
    obj1 = Napi::ObjectWrap<_VkAccelerationStructureNVX>::Unwrap(obj);
...
Napi::Value _vkGetAccelerationStructureMemoryRequirementsNVX(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  ...
  if (info[1].IsObject()) {
    Napi::Object obj = info[1].As<Napi::Object>();
    if (!(obj.InstanceOf(_VkAccelerationStructureMemoryRequirementsInfoNVX::constructor.Value()))) {
      NapiObjectTypeError(info[1], "argument 2", "[object VkAccelerationStructureMemoryRequirementsInfoNVX]");
      return env.Undefined();
    }
    obj1 = Napi::ObjectWrap<_VkAccelerationStructureMemoryRequirementsInfoNVX>::Unwrap(obj);
    if (!obj1->flush()) return env.Undefined();
    $p1 = &obj1->instance;
  } else if (info[1].IsNull()) {
    $p1 = nullptr;
...
Napi::Value _vkGetAccelerationStructureScratchMemoryRequirementsNVX(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
...
Napi::Value _vkBindAccelerationStructureMemoryNVX(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
...

  {
    ...
    for (unsigned int ii = 0; ii < array.Length(); ++ii) {
      Napi::Value item = array.Get(ii);
      Napi::Object obj = item.As<Napi::Object>();
      _VkBindAccelerationStructureMemoryInfoNVX* result = Napi::ObjectWrap<_VkBindAccelerationStructureMemoryInfoNVX>::Unwrap(obj);
      if (!result->flush()) return env.Undefined();
    };
  }
    Napi::Array array = info[2].As<Napi::Array>();
...
Napi::Value _vkCmdCopyAccelerationStructureNVX(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  ...
  if (info[0].IsObject()) {
    ...
    Napi::TypeError::New(env, "Expected 'Object' or 'null' for argument 1 'cmdBuf'").ThrowAsJavaScriptException();
  }
  ...
  if (info[2].IsObject()) {
    Napi::Object obj = info[2].As<Napi::Object>();
    if (!(obj.InstanceOf(_VkAccelerationStructureNVX::constructor.Value()))) {
      NapiObjectTypeError(info[2], "argument 3", "[object VkAccelerationStructureNVX]");
      return env.Undefined();
    }
    obj2 = Napi::ObjectWrap<_VkAccelerationStructureNVX>::Unwrap(obj);
  ...
  VkCopyAccelerationStructureModeNVX $p3 = static_cast<VkCopyAccelerationStructureModeNVX>(info[3].As<Napi::Number>().Int64Value());
...
Napi::Value _vkCmdWriteAccelerationStructurePropertiesNVX(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  ...
  VkQueryType $p2 = static_cast<VkQueryType>(info[2].As<Napi::Number>().Int64Value());
  ...
  if (info[3].IsObject()) {
    ...
    Napi::TypeError::New(env, "Expected 'Object' or 'null' for argument 4 'queryPool'").ThrowAsJavaScriptException();
  }
...
Napi::Value _vkCmdBuildAccelerationStructureNVX(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  ...
  VkAccelerationStructureTypeNVX $p1 = static_cast<VkAccelerationStructureTypeNVX>(info[1].As<Napi::Number>().Int64Value());
  ...
  if (info[3].IsObject()) {
    ...
    Napi::TypeError::New(env, "Expected 'Object' or 'null' for argument 4 'instanceData'").ThrowAsJavaScriptException();
  }
...

  {
    ...
    for (unsigned int ii = 0; ii < array.Length(); ++ii) {
      Napi::Value item = array.Get(ii);
      Napi::Object obj = item.As<Napi::Object>();
      _VkGeometryNVX* result = Napi::ObjectWrap<_VkGeometryNVX>::Unwrap(obj);
      if (!result->flush()) return env.Undefined();
    };
  }
    Napi::Array array = info[6].As<Napi::Array>();
    ...
    Napi::TypeError::New(env, "Invalid type for argument 7 'pGeometries'").ThrowAsJavaScriptException();
    return env.Undefined();
  }
  ...
  if (info[9].IsObject()) {
    ...
    if (!(obj.InstanceOf(_VkAccelerationStructureNVX::constructor.Value()))) {
      NapiObjectTypeError(info[9], "argument 10", "[object VkAccelerationStructureNVX]");
      return env.Undefined();
    }
    obj9 = Napi::ObjectWrap<_VkAccelerationStructureNVX>::Unwrap(obj);
    
    $p9 = &obj9->instance;
  } else if (info[9].IsNull()) {
    $p9 = VK_NULL_HANDLE;
  } else {
    Napi::TypeError::New(env, "Expected 'Object' or 'null' for argument 10 'dst'").ThrowAsJavaScriptException();
  }

  _VkAccelerationStructureNVX* obj10;
  VkAccelerationStructureNVX *$p10;
  if (info[10].IsObject()) {
    Napi::Object obj = info[10].As<Napi::Object>();
    if (!(obj.InstanceOf(_VkAccelerationStructureNVX::constructor.Value()))) {
      NapiObjectTypeError(info[10], "argument 11", "[object VkAccelerationStructureNVX]");
      return env.Undefined();
    }
    obj10 = Napi::ObjectWrap<_VkAccelerationStructureNVX>::Unwrap(obj);
    
    $p10 = &obj10->instance;
  } else if (info[10].IsNull()) {
    $p10 = VK_NULL_HANDLE;
  } else {
    Napi::TypeError::New(env, "Expected 'Object' or 'null' for argument 11 'src'").ThrowAsJavaScriptException();
  }

  _VkBuffer* obj11;
  VkBuffer *$p11;
  if (info[11].IsObject()) {
    Napi::Object obj = info[11].As<Napi::Object>();
    if (!(obj.InstanceOf(_VkBuffer::constructor.Value()))) {
      NapiObjectTypeError(info[11], "argument 12", "[object VkBuffer]");
      return env.Undefined();
    }
    obj11 = Napi::ObjectWrap<_VkBuffer>::Unwrap(obj);
    
    $p11 = &obj11->instance;
  } else if (info[11].IsNull()) {
    $p11 = VK_NULL_HANDLE;
  } else {
    Napi::TypeError::New(env, "Expected 'Object' or 'null' for argument 12 'scratch'").ThrowAsJavaScriptException();
  }

  uint64_t $p12 = static_cast<uint64_t>(info[12].As<Napi::Number>().Int64Value());
...
Napi::Value _vkCmdTraceRaysNVX(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
  ...
  uint32_t $p10 = static_cast<uint32_t>(info[10].As<Napi::Number>().Int64Value());
$vkCmdTraceRaysNVX(
    info[0].IsNull() ? VK_NULL_HANDLE : *$p0,
    info[1].IsNull() ? VK_NULL_HANDLE : *$p1,
    $p2,
...
Napi::Value _vkGetRaytracingShaderHandlesNVX(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
...
Napi::Value _vkGetAccelerationStructureHandleNVX(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
...
Napi::Value _vkCreateRaytracingPipelinesNVX(const Napi::CallbackInfo& info) {
  Napi::Env env = info.Env();
...

  {
    ...
    for (unsigned int ii = 0; ii < array.Length(); ++ii) {
      Napi::Value item = array.Get(ii);
      Napi::Object obj = item.As<Napi::Object>();
      _VkRaytracingPipelineCreateInfoNVX* result = Napi::ObjectWrap<_VkRaytracingPipelineCreateInfoNVX>::Unwrap(obj);
      if (!result->flush()) return env.Undefined();
    };
  }
    Napi::Array array = info[3].As<Napi::Array>();
