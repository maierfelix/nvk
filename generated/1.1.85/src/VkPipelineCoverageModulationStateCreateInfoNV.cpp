...
NAN_GETTER(_VkPipelineCoverageModulationStateCreateInfoNV::GetsType) {
  ...
  if (value->IsNumber()) {
    ...
    std::string msg = "Expected 'Number' for 'VkPipelineCoverageModulationStateCreateInfoNV.sType' but got '" + details + "'";
    Nan::ThrowTypeError(msg.c_str());
    return;
  }
}// pNext
NAN_GETTER(_VkPipelineCoverageModulationStateCreateInfoNV::GetpNext) {
  _VkPipelineCoverageModulationStateCreateInfoNV *self = Nan::ObjectWrap::Unwrap<_VkPipelineCoverageModulationStateCreateInfoNV>(info.This());
}NAN_SETTER(_VkPipelineCoverageModulationStateCreateInfoNV::SetpNext) {
  _VkPipelineCoverageModulationStateCreateInfoNV *self = Nan::ObjectWrap::Unwrap<_VkPipelineCoverageModulationStateCreateInfoNV>(info.This());
}// flags
NAN_GETTER(_VkPipelineCoverageModulationStateCreateInfoNV::Getflags) {
  ...
  if (value->IsNumber()) {
    ...
    std::string details = getV8ObjectDetails(value);
    if (details[0] == '#') details = "[object " + (details.substr(2, details.length() - 2 - 1)) + "]";
    std::string msg = "Expected 'Number' for 'VkPipelineCoverageModulationStateCreateInfoNV.flags' but got '" + details + "'";
    Nan::ThrowTypeError(msg.c_str());
    return;
  }
...
NAN_GETTER(_VkPipelineCoverageModulationStateCreateInfoNV::GetcoverageModulationMode) {
  ...
  if (value->IsNumber()) {
    ...
    std::string details = getV8ObjectDetails(value);
    if (details[0] == '#') details = "[object " + (details.substr(2, details.length() - 2 - 1)) + "]";
    std::string msg = "Expected 'Number' for 'VkPipelineCoverageModulationStateCreateInfoNV.coverageModulationMode' but got '" + details + "'";
    Nan::ThrowTypeError(msg.c_str());
    return;
  }
...
NAN_GETTER(_VkPipelineCoverageModulationStateCreateInfoNV::GetcoverageModulationTableEnable) {
  ...
  if (value->IsBoolean() || value->IsNumber()) {
    ...
    std::string details = getV8ObjectDetails(value);
    if (details[0] == '#') details = "[object " + (details.substr(2, details.length() - 2 - 1)) + "]";
    std::string msg = "Expected 'Number' for 'VkPipelineCoverageModulationStateCreateInfoNV.coverageModulationTableEnable' but got '" + details + "'";
    Nan::ThrowTypeError(msg.c_str());
    return;
  }
...
NAN_GETTER(_VkPipelineCoverageModulationStateCreateInfoNV::GetcoverageModulationTableCount) {
  ...
  if (value->IsNumber()) {
    ...
    std::string details = getV8ObjectDetails(value);
    if (details[0] == '#') details = "[object " + (details.substr(2, details.length() - 2 - 1)) + "]";
    std::string msg = "Expected 'Number' for 'VkPipelineCoverageModulationStateCreateInfoNV.coverageModulationTableCount' but got '" + details + "'";
    Nan::ThrowTypeError(msg.c_str());
    return;
  }
...
NAN_GETTER(_VkPipelineCoverageModulationStateCreateInfoNV::GetpCoverageModulationTable) {
  ...
  _VkPipelineCoverageModulationStateCreateInfoNV *self = Nan::ObjectWrap::Unwrap<_VkPipelineCoverageModulationStateCreateInfoNV>(info.This());
    ...
    std::string details = getV8ObjectDetails(value);
    if (details[0] == '#') details = "[object " + (details.substr(2, details.length() - 2 - 1)) + "]";
    std::string msg = "Expected 'Float32Array' for 'VkPipelineCoverageModulationStateCreateInfoNV.pCoverageModulationTable' but got '" + details + "'";
    Nan::ThrowTypeError(msg.c_str());
        return;
      }
