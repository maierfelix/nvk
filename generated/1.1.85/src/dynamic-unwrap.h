...
void * DynamicObjectUnwrapInstance(Napi::Object obj) {
  ...
  switch (sType) {
    ...
    case VK_STRUCTURE_TYPE_RAYTRACING_PIPELINE_CREATE_INFO_NVX: return (void *) &Napi::ObjectWrap<_VkRaytracingPipelineCreateInfoNVX>::Unwrap(obj)->instance;
    case VK_STRUCTURE_TYPE_GEOMETRY_TRIANGLES_NVX: return (void *) &Napi::ObjectWrap<_VkGeometryTrianglesNVX>::Unwrap(obj)->instance;
    case VK_STRUCTURE_TYPE_GEOMETRY_AABB_NVX: return (void *) &Napi::ObjectWrap<_VkGeometryAABBNVX>::Unwrap(obj)->instance;
    case VK_STRUCTURE_TYPE_GEOMETRY_NVX: return (void *) &Napi::ObjectWrap<_VkGeometryNVX>::Unwrap(obj)->instance;
    case VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_CREATE_INFO_NVX: return (void *) &Napi::ObjectWrap<_VkAccelerationStructureCreateInfoNVX>::Unwrap(obj)->instance;
    case VK_STRUCTURE_TYPE_BIND_ACCELERATION_STRUCTURE_MEMORY_INFO_NVX: return (void *) &Napi::ObjectWrap<_VkBindAccelerationStructureMemoryInfoNVX>::Unwrap(obj)->instance;
    case VK_STRUCTURE_TYPE_DESCRIPTOR_ACCELERATION_STRUCTURE_INFO_NVX: return (void *) &Napi::ObjectWrap<_VkDescriptorAccelerationStructureInfoNVX>::Unwrap(obj)->instance;
    case VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_MEMORY_REQUIREMENTS_INFO_NVX: return (void *) &Napi::ObjectWrap<_VkAccelerationStructureMemoryRequirementsInfoNVX>::Unwrap(obj)->instance;
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAYTRACING_PROPERTIES_NVX: return (void *) &Napi::ObjectWrap<_VkPhysicalDeviceRaytracingPropertiesNVX>::Unwrap(obj)->instance;
