...
Napi::Value getVulkanEnumerations(const Napi::CallbackInfo& info) {
  ...
  }
  {
    ...
    out.Set(Napi::String::New(env, "VkCopyAccelerationStructureModeNVX"), entry);
  }
  {
    std::map<std::string, __int32>::iterator it;
    Napi::Object entry = Napi::Object::New(env);
    ...
    out.Set(Napi::String::New(env, "VkAccelerationStructureTypeNVX"), entry);
  }
  {
    std::map<std::string, __int32>::iterator it;
    Napi::Object entry = Napi::Object::New(env);
    ...
    out.Set(Napi::String::New(env, "VkGeometryTypeNVX"), entry);
  }
  {
    std::map<std::string, __int32>::iterator it;
    Napi::Object entry = Napi::Object::New(env);
  ...
  }
  {
    ...
    out.Set(Napi::String::New(env, "VkGeometryInstanceFlagBitsNVX"), entry);
  }
  {
    std::map<std::string, __int32>::iterator it;
    Napi::Object entry = Napi::Object::New(env);
    ...
    out.Set(Napi::String::New(env, "VkGeometryFlagBitsNVX"), entry);
  }
  {
    std::map<std::string, __int32>::iterator it;
    Napi::Object entry = Napi::Object::New(env);
    ...
    out.Set(Napi::String::New(env, "VkBuildAccelerationStructureFlagBitsNVX"), entry);
  }
