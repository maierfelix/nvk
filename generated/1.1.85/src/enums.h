...
std::map<std::string, __int32> _VkAccessFlagBits = {
  ...
  { "VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT", 400 },
  ...
  { "VK_ACCESS_CONDITIONAL_RENDERING_READ_BIT_EXT", 100000 },
  { "VK_ACCESS_COMMAND_PROCESS_READ_BIT_NVX", 20000 },
  { "VK_ACCESS_COMMAND_PROCESS_WRITE_BIT_NVX", 40000 },
  { "VK_ACCESS_COLOR_ATTACHMENT_READ_NONCOHERENT_BIT_EXT", 80000 },
  { "VK_ACCESS_SHADING_RATE_IMAGE_READ_BIT_NV", 800000 },
  { "VK_ACCESS_ACCELERATION_STRUCTURE_READ_BIT_NVX", 200000 },
  { "VK_ACCESS_ACCELERATION_STRUCTURE_WRITE_BIT_NVX", 400000 },
  { "VK_ACCESS_RESERVED_24_BIT_EXT", 1000000 },
...
std::map<std::string, __int32> _VkBufferUsageFlagBits = {
  ...
  { "VK_BUFFER_USAGE_CONDITIONAL_RENDERING_BIT_EXT", 200 },
  { "VK_BUFFER_USAGE_RAYTRACING_BIT_NVX", 400 },
...
std::map<std::string, __int32> _VkShaderStageFlagBits = {
  ...
  { "VK_SHADER_STAGE_RAYGEN_BIT_NVX", 100 },
  { "VK_SHADER_STAGE_ANY_HIT_BIT_NVX", 200 },
  { "VK_SHADER_STAGE_CLOSEST_HIT_BIT_NVX", 400 },
  { "VK_SHADER_STAGE_MISS_BIT_NVX", 800 },
  { "VK_SHADER_STAGE_INTERSECTION_BIT_NVX", 1000 },
  { "VK_SHADER_STAGE_CALLABLE_BIT_NVX", 2000 },
...
std::map<std::string, __int32> _VkImageUsageFlagBits = {
  ...
  { "VK_IMAGE_USAGE_SHADING_RATE_IMAGE_BIT_NV", 100 },
  { "VK_IMAGE_USAGE_RESERVED_9_BIT_EXT", 200 },
...
std::map<std::string, __int32> _VkImageCreateFlagBits = {
  ...
  { "VK_IMAGE_CREATE_SAMPLE_LOCATIONS_COMPATIBLE_DEPTH_BIT_EXT", 1000 },
  { "VK_IMAGE_CREATE_DISJOINT_BIT_KHR", VK_IMAGE_CREATE_DISJOINT_BIT },
  { "VK_IMAGE_CREATE_ALIAS_BIT_KHR", VK_IMAGE_CREATE_ALIAS_BIT },
  { "VK_IMAGE_CREATE_RESERVED_14_BIT_EXT", 4000 },
...
std::map<std::string, __int32> _VkPipelineCreateFlagBits = {
  ...
  { "VK_PIPELINE_CREATE_DEFER_COMPILE_BIT_NVX", 20 },
...
std::map<std::string, __int32> _VkFormatFeatureFlagBits = {
  ...
  { "VK_FORMAT_FEATURE_STORAGE_TEXEL_BUFFER_ATOMIC_BIT", 20 },
  { "VK_FORMAT_FEATURE_VERTEX_BUFFER_BIT", 40 },
  { "VK_FORMAT_FEATURE_COLOR_ATTACHMENT_BIT", 80 },
  { "VK_FORMAT_FEATURE_COLOR_ATTACHMENT_BLEND_BIT", 100 },
  { "VK_FORMAT_FEATURE_DEPTH_STENCIL_ATTACHMENT_BIT", 200 },
  { "VK_FORMAT_FEATURE_BLIT_SRC_BIT", 400 },
  { "VK_FORMAT_FEATURE_BLIT_DST_BIT", 800 },
  { "VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_LINEAR_BIT", 1000 },
  { "VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_CUBIC_BIT_IMG", 2000 },
  { "VK_FORMAT_FEATURE_TRANSFER_SRC_BIT_KHR", VK_FORMAT_FEATURE_TRANSFER_SRC_BIT },
  { "VK_FORMAT_FEATURE_TRANSFER_DST_BIT_KHR", VK_FORMAT_FEATURE_TRANSFER_DST_BIT },
  { "VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_MINMAX_BIT_EXT", 10000 },
  ...
  { "VK_FORMAT_FEATURE_RESERVED_24_BIT_EXT", 1000000 },
...
std::map<std::string, __int32> _VkQueryPipelineStatisticFlagBits = {
  ...
  { "VK_QUERY_PIPELINE_STATISTIC_GEOMETRY_SHADER_PRIMITIVES_BIT", 10 },
  { "VK_QUERY_PIPELINE_STATISTIC_CLIPPING_INVOCATIONS_BIT", 20 },
  { "VK_QUERY_PIPELINE_STATISTIC_CLIPPING_PRIMITIVES_BIT", 40 },
  { "VK_QUERY_PIPELINE_STATISTIC_FRAGMENT_SHADER_INVOCATIONS_BIT", 80 },
  { "VK_QUERY_PIPELINE_STATISTIC_TESSELLATION_CONTROL_SHADER_PATCHES_BIT", 100 },
  { "VK_QUERY_PIPELINE_STATISTIC_TESSELLATION_EVALUATION_SHADER_INVOCATIONS_BIT", 200 },
  { "VK_QUERY_PIPELINE_STATISTIC_COMPUTE_SHADER_INVOCATIONS_BIT", 400 },
...
std::map<std::string, __int32> _VkPipelineStageFlagBits = {
  ...
  { "VK_PIPELINE_STAGE_TESSELLATION_CONTROL_SHADER_BIT", 10 },
  { "VK_PIPELINE_STAGE_TESSELLATION_EVALUATION_SHADER_BIT", 20 },
  ...
  { "VK_PIPELINE_STAGE_CONDITIONAL_RENDERING_BIT_EXT", 40000 },
  { "VK_PIPELINE_STAGE_COMMAND_PROCESS_BIT_NVX", 20000 },
  { "VK_PIPELINE_STAGE_SHADING_RATE_IMAGE_BIT_NV", 400000 },
  { "VK_PIPELINE_STAGE_RAYTRACING_BIT_NVX", 200000 },
  { "VK_PIPELINE_STAGE_TASK_SHADER_BIT_NV", 80000 },
  { "VK_PIPELINE_STAGE_MESH_SHADER_BIT_NV", 100000 },
  { "VK_PIPELINE_STAGE_RESERVED_23_BIT_EXT", 800000 },
...
std::map<std::string, __int32> _VkSurfaceTransformFlagBitsKHR = {
  ...
  { "VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_BIT_KHR", 10 },
  { "VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_ROTATE_90_BIT_KHR", 20 },
  { "VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_ROTATE_180_BIT_KHR", 40 },
  { "VK_SURFACE_TRANSFORM_HORIZONTAL_MIRROR_ROTATE_270_BIT_KHR", 80 },
...
std::map<std::string, __int32> _VkExternalMemoryHandleTypeFlagBits = {
  ...
  { "VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D11_TEXTURE_KMT_BIT", 10 },
  { "VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D12_HEAP_BIT", 20 },
  { "VK_EXTERNAL_MEMORY_HANDLE_TYPE_D3D12_RESOURCE_BIT", 40 },
  ...
  { "VK_EXTERNAL_MEMORY_HANDLE_TYPE_DMA_BUF_BIT_EXT", 200 },
  { "VK_EXTERNAL_MEMORY_HANDLE_TYPE_ANDROID_HARDWARE_BUFFER_BIT_ANDROID", 400 },
  { "VK_EXTERNAL_MEMORY_HANDLE_TYPE_HOST_ALLOCATION_BIT_EXT", 80 },
  { "VK_EXTERNAL_MEMORY_HANDLE_TYPE_HOST_MAPPED_FOREIGN_MEMORY_BIT_EXT", 100 },
...
std::map<std::string, __int32> _VkExternalSemaphoreHandleTypeFlagBits = {
  ...
  { "VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_SYNC_FD_BIT", 10 },
...
std::map<std::string, __int32> _VkDebugUtilsMessageSeverityFlagBitsEXT = {
  ...
  { "VK_DEBUG_UTILS_MESSAGE_SEVERITY_WARNING_BIT_EXT", 100 },
...
std::map<std::string, __int32> _VkBuildAccelerationStructureFlagBitsNVX = {
  ...
  { "VK_BUILD_ACCELERATION_STRUCTURE_LOW_MEMORY_BIT_NVX", 10 },
