...
static void init(v8::Handle<v8::Object> target, v8::Handle<v8::Object> module) {
  ...
  target->Set(
    Nan::New("vkCompileDeferredNVX").ToLocalChecked(),
    Nan::New<v8::FunctionTemplate>(_vkCompileDeferredNVX)->GetFunction()
  );
  target->Set(
    Nan::New("vkCreateAccelerationStructureNVX").ToLocalChecked(),
    Nan::New<v8::FunctionTemplate>(_vkCreateAccelerationStructureNVX)->GetFunction()
  );
  target->Set(
    Nan::New("vkDestroyAccelerationStructureNVX").ToLocalChecked(),
    Nan::New<v8::FunctionTemplate>(_vkDestroyAccelerationStructureNVX)->GetFunction()
  );
  target->Set(
    Nan::New("vkGetAccelerationStructureMemoryRequirementsNVX").ToLocalChecked(),
    Nan::New<v8::FunctionTemplate>(_vkGetAccelerationStructureMemoryRequirementsNVX)->GetFunction()
  );
  target->Set(
    Nan::New("vkGetAccelerationStructureScratchMemoryRequirementsNVX").ToLocalChecked(),
    Nan::New<v8::FunctionTemplate>(_vkGetAccelerationStructureScratchMemoryRequirementsNVX)->GetFunction()
  );
  target->Set(
    Nan::New("vkBindAccelerationStructureMemoryNVX").ToLocalChecked(),
    Nan::New<v8::FunctionTemplate>(_vkBindAccelerationStructureMemoryNVX)->GetFunction()
  );
  target->Set(
    Nan::New("vkCmdCopyAccelerationStructureNVX").ToLocalChecked(),
    Nan::New<v8::FunctionTemplate>(_vkCmdCopyAccelerationStructureNVX)->GetFunction()
  );
  target->Set(
    Nan::New("vkCmdWriteAccelerationStructurePropertiesNVX").ToLocalChecked(),
    Nan::New<v8::FunctionTemplate>(_vkCmdWriteAccelerationStructurePropertiesNVX)->GetFunction()
  );
  target->Set(
    Nan::New("vkCmdBuildAccelerationStructureNVX").ToLocalChecked(),
    Nan::New<v8::FunctionTemplate>(_vkCmdBuildAccelerationStructureNVX)->GetFunction()
  );
  target->Set(
    Nan::New("vkCmdTraceRaysNVX").ToLocalChecked(),
    Nan::New<v8::FunctionTemplate>(_vkCmdTraceRaysNVX)->GetFunction()
  );
  target->Set(
    Nan::New("vkGetRaytracingShaderHandlesNVX").ToLocalChecked(),
    Nan::New<v8::FunctionTemplate>(_vkGetRaytracingShaderHandlesNVX)->GetFunction()
  );
  target->Set(
    Nan::New("vkGetAccelerationStructureHandleNVX").ToLocalChecked(),
    Nan::New<v8::FunctionTemplate>(_vkGetAccelerationStructureHandleNVX)->GetFunction()
  );
  target->Set(
    Nan::New("vkCreateRaytracingPipelinesNVX").ToLocalChecked(),
    Nan::New<v8::FunctionTemplate>(_vkCreateRaytracingPipelinesNVX)->GetFunction()
  );
